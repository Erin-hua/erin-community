...
public class ErinController {
    ...
    // 不加@ResponseBody注解说明返回的是html
    public ModelAndView getTeacher() {
        ModelAndView mav = new ModelAndView();
        // 模板中要多少数据就添加多少个object
        mav.addObject("name", "erin");
        mav.addObject("age", 30);
        mav.setViewName("/demo/view"); // view = view.html
        return mav;
    }
    ...
    public String getSchool(Model model) {
        model.addAttribute("name", "湖南大学");
        model.addAttribute("age", 1046);
        return "/demo/view";
    }
